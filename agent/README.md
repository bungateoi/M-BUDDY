...
## M-BUDDY-Specific Notes

This backend serves the M-BUDDY mobile app's two AI functions (role-play +
scoring). See [`SPEC.md`](./SPEC.md) for the confirmed input/output
contracts before touching `main.py`'s handler logic.
